...
public class CorridaActivity extends AppCompatActivity
    ...
    GPSTracker gps;
    FloatingActionButton botaoChat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoChat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(requisicao != null) {
                    Intent intent = new Intent(CorridaActivity.this, ChatActivity.class);
        ...
        requisicoes.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(requisicao != null){
                    ...
                    localPassageiro = new LatLng(passageiro.getLocalizacaoAtual().getLatitude(), passageiro.getLocalizacaoAtual().getLongitude());
    ...
    public void centralizaDois() {
        LatLngBounds latLngBounds = new LatLngBounds.Builder()
                .include(localMotorista)
                .include(localPassageiro)
                .build();
    ...
    private void recuperarLocalizacaoUsuario() {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                motorista.setLocalizacaoAtual(new Localizacao(localMotorista.latitude, localMotorista.longitude));
