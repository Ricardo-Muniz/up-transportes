...
import com.upbrasil.up.activity.MainActivity;
...
public class UsuarioFirebase {
    ...
    public static Usuario getDadosUsuarioLogado(){
        ...
        usuario.setNomeCompleto( firebaseUser.getDisplayName() );
    ...
    public static void redirecionaUsuarioLogadoFacebook(final Activity activity, final String name, final String email, final String id){

        if(email != null ){
            Log.d("resultado", "onDataChange: " + email);
            ...
            usuariosRef.orderByChild("email").equalTo(email).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists()) {
                        for(DataSnapshot isset : dataSnapshot.getChildren()) {
                            Usuario usuario = isset.getValue( Usuario.class );
            ...
            Toast.makeText(activity, "User null", Toast.LENGTH_LONG).show();
        }
